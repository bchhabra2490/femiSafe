                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom" style="margin-top:40px">
                                <form role="form" action="signUpValidate.php" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fn" placeholder="First Name" class=" form-control" id="form-password">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Last Name</label>
                                        <input type="text" name="ln" placeholder="Last Name" class="form-control" id="form-password">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Email</label>
                                        <input type="text" name="email" placeholder="Email" class="form-control" id="form-password">
                                    </div>
                                    <div class="form-group">
                                        <input type="radio" name="type" value="0"> Lawyer
                                        <input type="radio" name="type" value="1"> Victim<br>                                  
                                    </div>
                                    <input type="submit" name="submit" class="btn btn-block btn-warning" value="Sign Up">
                                </form>
                            </div>
                        </div>
                    </div>            
